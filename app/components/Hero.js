    ...
    <section className="relative min-h-screen flex items-center justify-center pt-12 px-4 sm:px-6 lg:px-8 overflow-hidden">
      ...
      <div className="absolute inset-0 -z-10">
        ...
        <div className="absolute inset-0 opacity-[0.08]">
          <div className="h-full w-full bg-[length:60px_60px]" 
               style={{
        ...
        <div className="absolute inset-0 pointer-events-none">
          {/* React Icon */}
          <div className="absolute top-24 left-16 animate-bounce" style={{ animationDelay: '0s', animationDuration: '6s' }}>
            <FaReact className="text-blue-500 opacity-20 text-3xl" />
          </div>
          
          {/* JavaScript Icon */}
          <div className="absolute top-32 right-24 animate-bounce" style={{ animationDelay: '1s', animationDuration: '5s' }}>
            <FaJs className="text-yellow-500 opacity-20 text-2xl" />
          </div>
          
          {/* Next.js Icon */}
          <div className="absolute top-1/2 left-12 animate-bounce" style={{ animationDelay: '2s', animationDuration: '7s' }}>
            <SiNextdotjs className="text-gray-900 opacity-15 text-3xl" />
          </div>
          
          {/* HTML5 Icon */}
          <div className="absolute bottom-40 right-16 animate-bounce" style={{ animationDelay: '0.5s', animationDuration: '6s' }}>
            <FaHtml5 className="text-orange-500 opacity-20 text-2xl" />
          </div>
          
          {/* CSS3 Icon */}
          <div className="absolute bottom-24 left-24 animate-bounce" style={{ animationDelay: '1.5s', animationDuration: '5.5s' }}>
            <FaCss3Alt className="text-blue-600 opacity-20 text-2xl" />
          </div>
          
          {/* Tailwind CSS Icon */}
          <div className="absolute top-40 left-1/3 animate-bounce" style={{ animationDelay: '3s', animationDuration: '6.5s' }}>
          ...
          {/* Git Icon */}
          <div className="absolute bottom-48 left-1/4 animate-bounce" style={{ animationDelay: '3.5s', animationDuration: '6s' }}>
            <FaGitAlt className="text-red-500 opacity-20 text-2xl" />
          </div>
          
          {/* AWS Icon */}
          <div className="absolute top-56 right-1/3 animate-bounce" style={{ animationDelay: '4.5s', animationDuration: '5.5s' }}>
      ...
      <div className="relative max-w-7xl mx-auto text-center z-10">
        {/* Profile Image First */}
        <div className="mb-6">
          <div className="w-48 h-48 mx-auto rounded-full violet-gradient p-1 relative overflow-hidden">
        ...
        {/* Content Below */}
        <div>
          <h1 className="text-xl sm:text-2xl md:text-3xl text-gray-900 font-medium mb-4">
            Hi, I&apos;m{' '}
            <span className="text-gradient">Rajiv Sharma</span>
          </h1>
          ...
          <p className="text-base md:text-lg text-gray-600 mb-12 max-w-3xl mx-auto leading-relaxed">
            Passionate about creating modern, responsive web applications using React.js, Redux, and cloud technologies. 
            Currently building scalable solutions at Bodmas Education Services.
          </p>
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center space-y-4 sm:space-y-0 sm:space-x-6">
            ...
            <Link 
              href="#contact" 
              className="inline-flex items-center gap-2 border border-violet-600 text-violet-600 px-6 py-3 rounded-full font-medium transition-all duration-300 hover:bg-violet-600 hover:text-white active:scale-95"
            >
