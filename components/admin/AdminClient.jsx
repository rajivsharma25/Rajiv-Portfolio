    ...
    <div className="min-h-screen pt-20 sm:pt-24 pb-12 sm:pb-16 px-3.5 sm:px-6 lg:px-0 max-w-7xl mx-auto">
      ...
      <div className="flex items-center gap-2 mb-8 p-1.5 rounded-2xl bg-gray-100 dark:bg-neutral-900 border border-neutral-200/80 dark:border-neutral-800 w-fit">
        <button
          ...
          className={`flex items-center gap-2 px-4 sm:px-5 py-2 sm:py-2.5 rounded-xl text-xs sm:text-sm font-semibold transition-all cursor-pointer ${activeTab === "blogs"
        ...
        <button
          ...
          className={`flex items-center gap-2 px-4 sm:px-5 py-2 sm:py-2.5 rounded-xl text-xs sm:text-sm font-semibold transition-all cursor-pointer ${activeTab === "resume"
              ? "bg-white dark:bg-neutral-800 text-blue-600 dark:text-blue-400 shadow-xs"
              : "text-neutral-600 dark:text-neutral-400 hover:text-neutral-900 dark:hover:text-white"
            }`}
        >
      ...
      {statusMessage && (
        <div
          className={`mb-6 p-4 rounded-2xl flex items-center gap-3 text-sm font-medium ${statusMessage.type === "success"
            ...
            <div className="space-y-8">
              ...
              <div className="flex items-center gap-2 border-b border-neutral-200 dark:border-neutral-800 pb-3">
                <button
                  ...
                  className={`px-4 py-2 rounded-xl text-xs sm:text-sm font-semibold transition cursor-pointer ${currentView === "editor"
                ...
                <button
                  ...
                  className={`px-4 py-2 rounded-xl text-xs sm:text-sm font-semibold transition cursor-pointer ${currentView === "preview"
                      ? "bg-blue-600 text-white shadow-xs"
                      : "bg-neutral-100 dark:bg-neutral-800 text-neutral-600 dark:text-neutral-400 hover:text-neutral-900 dark:hover:text-white"
                    }`}
                >
